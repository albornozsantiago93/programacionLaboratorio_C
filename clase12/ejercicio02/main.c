...
#define CANTIDAD_MENUES 8
#define CANTIDAD_ALMUERZOS 8
...
int main()
{
    ...
    do
    {
        ...
        case 3://administrar almuerzos
            altaAlmuerzos(arrayAlmuerzos,CANTIDAD_ALMUERZOS,arrayMenues,arrayEmpleados,CANTIDAD_MENUES,CANTIDAD_EMPLEADOS);
            system("cls");
